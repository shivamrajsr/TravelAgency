...
interface TravelAgencyService {
    ...
    public void enrollInActivity(int passengerNumber,String packageId,String activityName, String destination) throws PassengerNotFoundException, NotEnoughBalanceException;
}
